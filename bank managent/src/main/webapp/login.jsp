...
<body>
    ...
    <form action="CustomerLogin" method="post">
        ...
        <div class="button-group">
            <button type="button" class="normal-button" onclick="location.href='ForgotenPassword.jsp'">Forgot Password</button>
            <button type="button" class="normal-button" onclick="location.href='adminLogin.jsp'">Admin Login</button>
        </div>
    </form>
    <script>
